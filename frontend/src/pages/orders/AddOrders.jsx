...
const AddOrders = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log(err);
      handleFail(
        "Ops, ah ocurrido un error interno al momento de crear el pedido"
      );
    }
  };
          ...
          <section className="flex flex-col bg-white rounded-xl shadow-xl mx-3 mb:my-8 mb:px-5 mb:py-5 md:py-5 md:my-3 md:px-20">
            ...
            <div className="flex flex-col mb-4">
              ...
              <select
                ...
                onChange={(e) => {
                  setOrder({ ...order, id_client_fk: e.target.value });
                }}
            ...
            <div className="flex flex-col mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setOrder({ ...order, delivery_day_order: e.target.value })
                }
                required
              />
            </div>
            ...
            <div className="flex flex-col mb-4">
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-2 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-s"
                onChange={(e) =>
                  setOrder({ ...order, shipping_address_order: e.target.value })
                }
              />
            </div>
