  ...
  const handleCreate = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/suppliers/create`,
        {
          method: "POST",
      ...
      console.log(err);
      handleFail(
        "Ops! Error inesperado ocurrido a la hora de crear el proveedor"
      );
      setLoader(false);
    }
  };
        ...
        <section className="flex w-full h-full justify-center bg-gray-200">
          ...
          <section className="flex flex-col bg-white rounded-xl shadow-xl p-10 m-5">
            ...
            <div className="mb-4">
              ...
              />
              <CharacterCounter value={supplier.description_supplier} />
            </div>
            <button
