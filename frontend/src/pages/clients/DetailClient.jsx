...
const DetailClient = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_API_URL}/clients/details/${id}`,
          {
            method: "GET",
            credentials: "include",
          }
  ...
  const handleDNI = (e) => {
    ...
    if (e.target.value.length < 8) {
      ...
      if (regExNum.test(e.nativeEvent.key)) {
        setUpdatedClient({
          ...updatedClient,
          dni_client: preValue + e.nativeEvent.key,
        });
      }
    }
  ...
  const handleCUITorCUIT = (e) => {
    ...
    if (e.target.value.length < 11) {
      if (regExNum.test(e.nativeEvent.key)) {
        setUpdatedClient({
          ...updatedClient,
          cuil_or_cuit_client: preValue + e.nativeEvent.key,
        });
      }
    }
    if (e.nativeEvent.key === "Backspace") {
      if (e.target.value.length === 1) {
        ...
        setUpdatedClient({
          ...updatedClient,
          cuil_or_cuit_client: preValue.slice(0, -1),
        });
      }
    }
  };
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/clients/update/${id}`,
        {
          method: "PATCH",
  ...
  const handleDisable = async () => {
    try {
      ...
      if (confirmDelete) {
        setLoader(true);
        const response = await fetch(
          `${process.env.REACT_APP_API_URL}/clients/disabled/${id}`,
          {
            method: "PATCH",
            headers: { "Content-Type": "application/json" },
            credentials: "include",
            ...
            <section className="flex w-full h-full justify-center bg-gray-200">
              ...
              <section className="flex flex-col bg-white rounded-xl shadow-xl mx-6 mb:my-6 mb:px-2 mb:py-5 md:py-5 md:my-3 md:px-20 justify-center items-center mb:text-center">
                ...
                <h2 className="text-2xl font-bold mb-4 text-center">
                  Detalles del cliente: {client.name_client}{" "}
                  {client.last_name_client}
                </h2>
                {/* COLUMNA DE INPUTS */}
            ...
            <section className="flex w-full h-full justify-center bg-gray-200">
              ...
              <section className="flex flex-col bg-white rounded-xl shadow-xl mx-6 mb:my-6 mb:px-2 mb:py-5 md:py-5 md:my-3 md:px-20 justify-center items-center mb:text-center">
                ...
                <h2 className="text-2xl font-bold mb-4 mx-5">
                  Actualizar cliente: {updatedClient.name_client}{" "}
                  {updatedClient.last_name_client}
                </h2>
                {/* COLUMNA DE INPUTS */}
                <div className="flex flex-col md:flex-row gap-2">
                  {/* COLUMNA Nº 1 */}
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setUpdatedClient({
                            ...updatedClient,
                            last_name_client: e.target.value,
                          })
                        }
                        required
                      />
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setUpdatedClient({
                            ...updatedClient,
                            phone_number_client: e.target.value,
                          })
                        }
                        required
                      />
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setUpdatedClient({
                            ...updatedClient,
                            direction_client: e.target.value,
                          })
                        }
                        required
                      />
