  ...
  const handleCreate = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/clients/create`,
        {
          method: "POST",
          ...
          <section className="flex flex-col bg-white rounded-xl shadow-xl mx-3 mb:my-8 mb:px-5 mb:py-5 md:py-5 md:my-3 md:px-20 justify-center items-center mb:text-center">
            ...
            <div className="flex flex-col md:flex-row gap-2 mx-8">
              ...
              <div className="flex flex-col md:p-2 md:mx-5">
                {/* NOMBRE */}
                <div className="mb-4">
                  <label htmlFor="name_client" className="block text-gray-700">
                    Nombre: *
                  </label>
                  <input
                    type="text"
                    ...
                    onChange={(e) =>
                      setClient({ ...client, name_client: e.target.value })
                    }
                    required
                  />
                </div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    onChange={(e) =>
                      setClient({ ...client, last_name_client: e.target.value })
                    }
                  />
                </div>
                {/* DNI */}
                <div className="mb-4">
                  <label htmlFor="dni_client" className="block text-gray-700">
                    DNI:
                  </label>
                  <input
                    type="text"
              ...
              <div className="flex flex-col md:p-2 md:mx-5">
                ...
                {/* TIPO DE CLIENTE */}
                <div className="mb-4">
                  <label htmlFor="type_client" className="block text-gray-700">
                    Tipo de cliente: *
                  </label>
                  <select
                    name="type_client"
                    ...
                    onChange={(e) => {
                      if (e.target.value !== "none")
                        setClient({ ...client, type_client: e.target.value });
                    }}
                    required
                  >
              ...
              <div className="flex flex-col md:p-2 md:mx-5">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    onChange={(e) =>
                      setClient({ ...client, direction_client: e.target.value })
                    }
                    required
                  />
                </div>
                {/* MAIL */}
                <div className="mb-4">
                  <label htmlFor="mail_client" className="block text-gray-700">
                    Correo Electrónico:
                  </label>
                  <input
                    type="email"
                    ...
                    className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    onChange={(e) =>
                      setClient({ ...client, mail_client: e.target.value })
                    }
                  />
                </div>
              </div>
