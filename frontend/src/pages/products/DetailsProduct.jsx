...
const DetailsProduct = () => {
    ...
    const [chancheImg, setChangeImg] = useState(false);
                ...
                <div className="max-w-4xl mx-auto p-6 bg-gray-100 rounded-lg shadow-md">
                    ...
                    <section className="w-full h-full flex-col bg-gray-100 px-6 py-2 mt-2 rounded-lg shadow-md">
                        ...
                        <div className="flex flex-row">
                            {/* Imagen */}
                            <div className="flex flex-col m-auto">
                                <button className="rounded-lg text-white bg-indigo-600 hover:bg-indigo-800 font-bold mx-auto py-2 px-4" onClick={()=> setChangeImg(true)}>
                                <FontAwesomeIcon icon={faFileImage} className="mr-2"/>
                                    Cambiar Imagen
                                </button>
                                {chancheImg ? (
                                    <input type="file" className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm my-3" id="img_product" name="img_product" onChange={handleChange}/>
                                ) : (
