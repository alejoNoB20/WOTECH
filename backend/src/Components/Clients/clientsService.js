...
export class clientsService {
  verClientes = async (page) => {
    try {
      ...
      return try_catch.SERVICE_TRY_RES(
        { resultado, maxPage: maxClients / limit },
        200
      );
    } catch (err) {
      return try_catch.SERVICE_CATCH_RES(
        err,
        "No se pueden ver los clientes debido a una falla en el sistema"
      );
    }
  };
  crearCliente = async (data) => {
    try {
      ...
      return try_catch.SERVICE_TRY_RES(
        "La creación del cliente finalizó exitosamente",
        201
      );
    } catch (err) {
  ...
  deshabilitarCliente = async (id_client) => {
    try {
      ...
      return try_catch.SERVICE_TRY_RES(
        "La deshabilitación del cliente termino exitosamente",
        200
      );
    } catch (err) {
      return try_catch.SERVICE_CATCH_RES(
        err,
        "La deshabilitación del cliente falló"
      );
    }
  };
  eliminarCliente = async (id_client) => {
    try {
      ...
      return try_catch.SERVICE_TRY_RES(
        "La eliminación del cliente finalizó exitosamente",
        200
      );
    } catch (err) {
      return try_catch.SERVICE_CATCH_RES(
        err,
        "La eliminación del cliente falló"
      );
    }
  };
  actualizarCliente = async (id_client, data) => {
    try {
      ...
      return try_catch.SERVICE_TRY_RES(
        "La actualización del cliente finalizó exitosamente",
        200
      );
    } catch (err) {
      return try_catch.SERVICE_CATCH_RES(
        err,
        "La actualización del cliente falló"
      );
    }
  };
