...
export class supplierService {
    ...
    try {
      ...
      if (resultado.length === 0)
        return try_catch.SERVICE_TRY_RES(
          { resultado: "No se encontró ningún proveedor en la base de datos" },
          404
        );
      ...
      return try_catch.SERVICE_CATCH_RES(
        err,
        "No se pueden ver los proveedores debido a una falla en el sistema"
      );
    }
  };
  ...
  crearProveedor = async (data) => {
    try {
      ...
      return try_catch.SERVICE_TRY_RES(
        "La creación del proveedor finalizó exitosamente",
        201
      );
    } catch (err) {
      return try_catch.SERVICE_CATCH_RES(
        err,
        "La creación del proveedor falló"
      );
    }
  };
  deshabilitarProveedor = async (id_supplier) => {
    try {
      ...
      return try_catch.SERVICE_TRY_RES(
        `La deshabilitación del proveedor finalizó exitosamente`,
        200
      );
    } catch (err) {
      return try_catch.SERVICE_CATCH_RES(
        err,
        "La deshabilitación del proveedor falló"
      );
    }
  };
  borrarProveedor = async (id_supplier) => {
    try {
      ...
      return try_catch.SERVICE_TRY_RES(
        `La eliminación del proveedor finalizó exitosamente`,
        200
      );
    } catch (err) {
      return try_catch.SERVICE_CATCH_RES(
        err,
        "La elimación del proveedor falló"
      );
    }
  };
  actualizarProveedor = async (id_supplier, data) => {
    try {
      ...
      return try_catch.SERVICE_TRY_RES(
        `La actualización del proveedor finalizó exitosamente`,
        200
      );
    } catch (err) {
      return try_catch.SERVICE_CATCH_RES(
        err,
        "La actualización del proveedor falló"
      );
    }
  };
  filtrarProveedor = async (page, type, value) => {
    try {
      ...
      if (
        type === "id_supplier" ||
        type === "nameCompanyValidation" ||
        type === "cuitCompanyValidation"
      ) {
